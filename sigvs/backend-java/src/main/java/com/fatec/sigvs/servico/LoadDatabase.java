...
public class LoadDatabase {
	...
	CommandLineRunner initDatabase(IProdutoRepository repository) {
		return args -> {
			...
			// ****************************************************************
			Path path = Paths.get("C:/Users/kpopc/Documents/img/produto1.jpg");
			...
			// ****************************************************************
			path = Paths.get("C:/Users/kpopc/Documents/img/produto2.jpg");
			...
			imagemRepository.save(imagem);
			// ****************************************************************
			path = Paths.get("C:/Users/kpopc/Documents/img/produto3.jpg");
			file = Files.newInputStream(path);
