...
public class Produto {
	...
	public void setCategoria(String categoria) {
		if(categoria == null || categoria.isBlank()) {
			throw new IllegalArgumentException("A categoria não deve estar em casa");
		}else {
			this.categoria = categoria;
		}
	}
	...
	public void setCusto(double custo) {
		try {
			...
			throw new IllegalArgumentException("O custo deve ser numérico maior que zero");
		}
	}
	...
	public void setQuantidadeNoEstoque(int quantidadeNoEstoque) {
		try {
			...
			throw new IllegalArgumentException("A quantidade deve ser um valor numérico maior que zero");
		}
